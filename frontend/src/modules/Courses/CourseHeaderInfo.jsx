  ...
  return (
    ...
    <div className={`text-white ${style}  max-w-2xl space-y-3`}>
                ...
                <div className="grid grid-cols-2 gap-3 lg:flex sm:grid-cols-3  pb-1 text-sm ">
                  <p>Enrollment:<span className='font-semibold'> {courseDetails.enrollmentStatus} </span></p>
                  <p>Duration: <span className='font-semibold'> 6 month </span></p>
                  <p>Location:<span className='font-semibold'>  Gurugram, India</span> </p>
                </div>
              </div>
